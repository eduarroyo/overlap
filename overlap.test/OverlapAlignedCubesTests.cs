...
namespace overlap.test
{
    public class OverlapAlignedCubesTests
    {
        ...
        [TestCase(2, 2, 2, 2, 2, 2, 10, 2, false, "The cubes don't touch to each other, with aligned centers")]
        [TestCase(2, 2, 2, 2, 6, 11, 10, 2, false, "The cubes don't touch to each other, with non-aligned centers")]
