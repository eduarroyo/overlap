...
namespace overlap.test
{
    public class OverlapAlignedCubesTests
    {
        ...
        [TestCase(2, 2, 2, 2, 2, 2, 2, 2, true, "Both cubes have the same center but different edges")]
        ...
        {
            AlignedCube cubeA = new AlignedCube(cube_a_x, cube_a_y, cube_a_z, cube_a_edge_length);
            AlignedCube cubeB = new AlignedCube(cube_b_x, cube_b_y, cube_b_z, cube_b_edge_length);
